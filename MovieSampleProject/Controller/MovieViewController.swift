    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == ForYouColl  {
           guard let cellFor = collectionView.dequeueReusableCell(withReuseIdentifier: "ForYouCell", for: indexPath) as?
            ...
            cellFor.ForYouGenre.text = _movieForYou[indexPath.row].movieGenre
            cellFor.ForYouYear.text = "\(_movieForYou[indexPath.row].movieYear)"
        ...
        else
        {
           ...
           PopularCollectionViewCell else { return UICollectionViewCell() }
            ...
            cellPop.PopularYear.text = "\(_moviePopular[indexPath.row].movieYear)"
